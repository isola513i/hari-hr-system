...
import { employeeOffboardingRouter, offboardingTaskRouter } from "./routes/offboardingRoutes";
...
app.use("/api/employees", employeeOffboardingRouter);
app.use("/api/offboarding", offboardingTaskRouter);
