...
export const TimeOff: React.FC = () => {
  const { user } = useAuth();
  const { requests, addRequest } = useLeave();
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="p-6 bg-card-light dark:bg-card-dark rounded-xl border border-border-light dark:border-border-dark shadow-sm">
          <div className="flex justify-between items-start mb-4">
             ...
             <span className="text-xs font-medium bg-blue-50 dark:bg-blue-900/10 text-blue-600 px-2 py-1 rounded">14 Days Left</span>
          </div>
          <h3 className="text-2xl font-bold text-text-light dark:text-text-dark">Vacation</h3>
          <p className="text-xs text-text-muted-light mt-1">Total 20 days / year</p>
        </div>
        ...
        <div className="p-6 bg-card-light dark:bg-card-dark rounded-xl border border-border-light dark:border-border-dark shadow-sm">
           <div className="flex justify-between items-start mb-4">
             ...
             <span className="text-xs font-medium bg-orange-50 dark:bg-orange-900/10 text-orange-600 px-2 py-1 rounded">5 Days Left</span>
          </div>
          <h3 className="text-2xl font-bold text-text-light dark:text-text-dark">Sick Leave</h3>
          <p className="text-xs text-text-muted-light mt-1">Total 10 days / year</p>
        </div>
        ...
        <div className="p-6 bg-card-light dark:bg-card-dark rounded-xl border border-border-light dark:border-border-dark shadow-sm">
           <div className="flex justify-between items-start mb-4">
             ...
             <span className="text-xs font-medium bg-purple-50 dark:bg-purple-900/10 text-purple-600 px-2 py-1 rounded">Unlimited</span>
          </div>
          <h3 className="text-2xl font-bold text-text-light dark:text-text-dark">Unpaid Leave</h3>
          <p className="text-xs text-text-muted-light mt-1">Requires Approval</p>
        </div>
      </div>
